...
// File: LCDMenuLib_makros.h 
//#define __LCDML_lcd_type						LiquidCrystal

//#define __LCDML_lcd_object_init_global			LiquidCrystal lcd(_LCDMenuLib_PIN_rs, _LCDMenuLib_PIN_e, _LCDMenuLib_PIN_dat4, _LCDMenuLib_PIN_dat5, _LCDMenuLib_PIN_dat6, _LCDMenuLib_PIN_dat7)




//#define __LCDML_class_name						LcdMenuLib_##__LCDML_lcd_type
...
//# Lcd Menu Lib
//# =======================
class LcdMenuLib_LiquidCrystal
{
    private:
    ...
    public:
		...
		LcdMenuLib_LiquidCrystal(LCDMenu &p_r,LiquidCrystal &p_d, const char **p_flash_table, const uint8_t p_rows, const uint8_t p_cols);        
