/* ===============================================
 * Example: LCDMenuLib I2C (german doku)
 * ===============================================
 ...
 * 
 * Schaut bitte auch in die LCDMenuLib_config.h und stellt die Variabel _LCDMenuLib_cfg_lcd_type für euren LCD Type passend ein
 */
...
//Liquidcrystal 4Bit Mode     LiquidCrystal_I2C rs,e mode
...
#define _LCDMenuLib_INIT_SCREEN_TIME              60000
